...
mod tests {
    ...
    fn test_basic_insertion() {
        ...
        tracker.get_or_insert_with(&1, || FlowData { timestamp: 100, bytes: 1000, packets: 10 });
        tracker.get_or_insert_with(&2, || FlowData { timestamp: 200, bytes: 2000, packets: 20 });
        tracker.get_or_insert_with(&3, || FlowData { timestamp: 300, bytes: 3000, packets: 30 });
    ...
    fn test_lru_behavior() {
        ...
        tracker.get_or_insert_with(&1, || FlowData { timestamp: 400, bytes: 1000, packets: 10 });
    ...
    fn test_get_or_insert_with() {
        ...
        tracker.get_or_insert_with(&1, || FlowData { timestamp: 200, bytes: 9999, packets: 99 });
    ...
    fn test_process_and_evict_basic() {
        ...
        tracker.get_or_insert_with(&2, || FlowData { timestamp: 200, bytes: 2000, packets: 20 });
        tracker.get_or_insert_with(&3, || FlowData { timestamp: 300, bytes: 3000, packets: 30 });
        tracker.get_or_insert_with(&4, || FlowData { timestamp: 400, bytes: 4000, packets: 40 });
